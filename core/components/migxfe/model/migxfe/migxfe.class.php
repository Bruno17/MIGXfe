...
class MigxFe {
    ...
    /**
     * @access public
     * @var array A collection of properties to adjust MIGXfe behaviour.
     */
    public $config = array();
    /**
     * @access public
    ...
    /**
     * The MIGXfe Constructor.
     *
     * This method is used to create a new MIGXfe object.
     *
     * @param modX &$modx A reference to the modX object.
     * @param array $config A collection of properties that modify MIGXfe
     * behaviour.
     * @return MIGXfe A unique MIGXfe instance.
     */
    function __construct(modX & $modx, array $config = array()) {
        ...
        */
        $corePath = $this->modx->getOption('migxfe.core_path', null, $modx->getOption('core_path') . 'components/migxfe/');
        $assetsPath = $this->modx->getOption('migxfe.assets_path', null, $modx->getOption('assets_path') . 'components/migxfe/');
        $assetsUrl = $this->modx->getOption('migxfe.assets_url', null, $modx->getOption('assets_url') . 'components/migxfe/');
    ...
    function createForm(&$tabs, &$record, &$allfields, &$categories, $scriptProperties, &$xtypes) {
                ...
                foreach ($fields as &$field) {
                    ...
                    if (isset($field['description_is_code']) && !empty($field['description_is_code'])) {
                        ...
                        */
                        ...
                        //Todo: Create plugin-event OnTVInputRenderListMIGXfe to get custom TV-rendererPaths
